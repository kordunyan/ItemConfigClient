...
export class MandatoryDataHttpService extends AbstractHttpService {
  private static BASE_PATH = '/mandatory/data';

  constructor(http: HttpClient, messageService: MessageService, rboCodeService: RboCodeService) {
    super(http, messageService, rboCodeService, MandatoryDataHttpService.BASE_PATH);
  }
