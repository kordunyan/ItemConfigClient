...
export class ItemFieldsHolder {
    ...
    constructor(public item: Item, public fieldConfigs: FieldConfig[]) {
    ...
    public deleteField(field: Field) {
        ...
        this.noActiveFieldConfigs.push(this.fieldConfigs.find(fc => fc.name === field.fieldConfigName));
    }
    ...
    public isMultiple(field: Field): boolean {
        return this.fieldConfigs[field.fieldConfigName] && this.fieldConfigs[field.fieldConfigName].multiple;
    }
}